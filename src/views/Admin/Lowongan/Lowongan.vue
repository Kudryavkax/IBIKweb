        ...
        <div class="tablelowongan">
          <div class="search">
            <b-container fluid>
              <b-row class="my-1">
                ...
                <b-col>
                  <b-btn class="btnadd" to="lowongan/add"><b-icon icon="plus-circle-fill"></b-icon></b-btn>
                </b-col>
              </b-row>
            </b-container>
          </div>
          <b-table hover 
            ...
            <template #cell(Perintah)="row">
                <b-button size="sm" class="mr-1" :to='"lowongan/edit/"+row.item.Key'>
                Edit
                </b-button>
                <b-button size="sm">
                Delete
...
export default {
    ...
    data() {
      return {
        fields: ['JudulLowongan', 'Tanggal','Perintah'],
        items: [
          { Key: 1,
            JudulLowongan: 'Webinar IDStar "Moving Towards Society 5.0"', 
